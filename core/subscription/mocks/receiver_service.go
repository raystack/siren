...
func (_c *ReceiverService_CreateReceiver_Call) Run(run func(_a0 *domain.Receiver)) *ReceiverService_CreateReceiver_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*domain.Receiver))
	})
	return _c
}
...
func (_c *ReceiverService_GetReceiver_Call) Return(_a0 *domain.Receiver, _a1 error) *ReceiverService_GetReceiver_Call {
...
func (_c *ReceiverService_ListReceivers_Call) Return(_a0 []*domain.Receiver, _a1 error) *ReceiverService_ListReceivers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_c *ReceiverService_UpdateReceiver_Call) Run(run func(_a0 *domain.Receiver)) *ReceiverService_UpdateReceiver_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*domain.Receiver))
	})
	return _c
