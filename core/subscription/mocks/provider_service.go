...
func (_m *ProviderService) Create(_a0 context.Context, _a1 *provider.Provider) (uint64, error) {
...
func (_c *ProviderService_Create_Call) Return(_a0 uint64, _a1 error) *ProviderService_Create_Call {
...
func (_m *ProviderService) Update(_a0 context.Context, _a1 *provider.Provider) (uint64, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *ProviderService_Update_Call) Return(_a0 uint64, _a1 error) *ProviderService_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
