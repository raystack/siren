...
func (_c *ReceiverRepository_Create_Call) RunAndReturn(run func(context.Context, *receiver.Receiver) error) *ReceiverRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ReceiverRepository_Delete_Call) RunAndReturn(run func(context.Context, uint64) error) *ReceiverRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ReceiverRepository_Get_Call) RunAndReturn(run func(context.Context, uint64) (*receiver.Receiver, error)) *ReceiverRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ReceiverRepository_List_Call) RunAndReturn(run func(context.Context, receiver.Filter) ([]receiver.Receiver, error)) *ReceiverRepository_List_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ReceiverRepository_Update_Call) RunAndReturn(run func(context.Context, *receiver.Receiver) error) *ReceiverRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
...
func NewReceiverRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *ReceiverRepository {
