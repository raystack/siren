...
func (_m *Repository) Get(_a0 context.Context, _a1 uint64) (*receiver.Receiver, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) (*receiver.Receiver, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_c *Repository_Get_Call) RunAndReturn(run func(context.Context, uint64) (*receiver.Receiver, error)) *Repository_Get_Call {
	_c.Call.Return(run)
	return _c
}
