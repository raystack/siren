...
// NewEncryptor creates a new instance of Encryptor. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEncryptor(t testing.TB) *Encryptor {
	mock := &Encryptor{}
	mock.Mock.Test(t)
