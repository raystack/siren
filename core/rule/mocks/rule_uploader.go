...
func (_c *RuleUploader_UpsertRule_Call) RunAndReturn(run func(context.Context, string, provider.Provider, *rule.Rule, *template.Template) error) *RuleUploader_UpsertRule_Call {
	_c.Call.Return(run)
	return _c
}
