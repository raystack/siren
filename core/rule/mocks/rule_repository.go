...
func (_m *RuleRepository) UpsertWithTx(_a0 context.Context, _a1 *rule.Rule, _a2 func([]rule.Rule) error) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *rule.Rule, func([]rule.Rule) error) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *RuleRepository_UpsertWithTx_Call) Return(_a0 error) *RuleRepository_UpsertWithTx_Call {
	_c.Call.Return(_a0)
	return _c
}
