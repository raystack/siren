...
func (_m *TemplateService) Upsert(_a0 context.Context, _a1 *template.Template) (uint64, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *TemplateService_Upsert_Call) Return(_a0 uint64, _a1 error) *TemplateService_Upsert_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
