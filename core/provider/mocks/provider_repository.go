...
func (_c *ProviderRepository_Create_Call) RunAndReturn(run func(context.Context, *provider.Provider) error) *ProviderRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ProviderRepository_Delete_Call) RunAndReturn(run func(context.Context, uint64) error) *ProviderRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ProviderRepository_Get_Call) RunAndReturn(run func(context.Context, uint64) (*provider.Provider, error)) *ProviderRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ProviderRepository_List_Call) RunAndReturn(run func(context.Context, provider.Filter) ([]provider.Provider, error)) *ProviderRepository_List_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ProviderRepository_Update_Call) RunAndReturn(run func(context.Context, *provider.Provider) error) *ProviderRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
