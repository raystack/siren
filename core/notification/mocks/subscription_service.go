...
// MatchByLabels provides a mock function with given fields: ctx, labels
func (_m *SubscriptionService) MatchByLabels(ctx context.Context, labels map[string]string) ([]subscription.Subscription, error) {
	ret := _m.Called(ctx, labels)

	var r0 []subscription.Subscription
	if rf, ok := ret.Get(0).(func(context.Context, map[string]string) []subscription.Subscription); ok {
		r0 = rf(ctx, labels)
	} else {
		if ret.Get(0) != nil {
...
func (_e *SubscriptionService_Expecter) MatchByLabels(ctx interface{}, labels interface{}) *SubscriptionService_MatchByLabels_Call {
	return &SubscriptionService_MatchByLabels_Call{Call: _e.mock.On("MatchByLabels", ctx, labels)}
}

func (_c *SubscriptionService_MatchByLabels_Call) Run(run func(ctx context.Context, labels map[string]string)) *SubscriptionService_MatchByLabels_Call {
