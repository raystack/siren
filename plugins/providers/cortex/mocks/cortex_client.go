...
import (
	...
	cortex "github.com/odpf/siren/plugins/providers/cortex"
...
func (_m *CortexClient) GetAlertmanagerConfig(ctx context.Context) (string, map[string]string, error) {
	ret := _m.Called(ctx)
...
// CortexClient_GetAlertmanagerConfig_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAlertmanagerConfig'
type CortexClient_GetAlertmanagerConfig_Call struct {
	*mock.Call
}

// GetAlertmanagerConfig is a helper method to define mock.On call
//  - ctx context.Context
func (_e *CortexClient_Expecter) GetAlertmanagerConfig(ctx interface{}) *CortexClient_GetAlertmanagerConfig_Call {
	return &CortexClient_GetAlertmanagerConfig_Call{Call: _e.mock.On("GetAlertmanagerConfig", ctx)}
}

func (_c *CortexClient_GetAlertmanagerConfig_Call) Run(run func(ctx context.Context)) *CortexClient_GetAlertmanagerConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CortexClient_GetAlertmanagerConfig_Call) Return(_a0 string, _a1 map[string]string, _a2 error) *CortexClient_GetAlertmanagerConfig_Call {
...
type mockConstructorTestingTNewCortexClient interface {
	mock.TestingT
	Cleanup(func())
}
