...
// ReceiverService is a receiver plugin service layer for file
type ReceiverService struct {
	base.UnimplementedReceiverService
}

// NewReceiverService returns file receiver service struct. This service implement [receiver.Resolver] interface.
