...
func TestClient_Notify_WithoutRetrier(t *testing.T) {
	testCases := []struct {
		name    string
		ctx     context.Context
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			c := httpreceiver.NewClient(log.NewNoop(), tc.cfg)
...
func TestClient_Notify_HTTPCall(t *testing.T) {
...
func TestClient_Notify_WithRetrier(t *testing.T) {
