...
func (_m *SlackCaller) ExchangeAuth(ctx context.Context, authCode string, clientID string, clientSecret string) (slack.Credential, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ExchangeAuth")
	}

	var r0 slack.Credential
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) (slack.Credential, error)); ok {
		return rf(ctx, authCode, clientID, clientSecret)
	}
...
func (_m *SlackCaller) GetWorkspaceChannels(ctx context.Context, token secret.MaskableString) ([]slack.Channel, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, secret.MaskableString) ([]slack.Channel, error)); ok {
		return rf(ctx, token)
	}
...
func NewSlackCaller(t interface {
	mock.TestingT
	Cleanup(func())
}) *SlackCaller {
	mock := &SlackCaller{}
