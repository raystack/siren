...
func (_m *GoSlackCaller) GetConversationsForUserContext(ctx context.Context, params *slack.GetConversationsForUserParameters) ([]slack.Channel, string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetConversationsForUserContext")
	}

	var r0 []slack.Channel
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *slack.GetConversationsForUserParameters) ([]slack.Channel, string, error)); ok {
...
func (_m *GoSlackCaller) SendMessageContext(ctx context.Context, channel string, options ...slack.MsgOption) (string, string, string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for SendMessageContext")
	}
...
func (_c *GoSlackCaller_SendMessageContext_Call) RunAndReturn(run func(context.Context, string, ...slack.MsgOption) (string, string, string, error)) *GoSlackCaller_SendMessageContext_Call {
	_c.Call.Return(run)
	return _c
}
...
func NewGoSlackCaller(t interface {
	mock.TestingT
	Cleanup(func())
}) *GoSlackCaller {
	mock := &GoSlackCaller{}
