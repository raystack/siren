...
// func NginxWithDockerPool(pool *dockertestx.Pool) dockerNginxOption {
// 	return func(dc *dockerNginx) {
// 		dc.pool = pool
// 	}
// }
...
// 	dockertestResource *dockertestx.Resource
// }
...
// 	if dc.pool == nil {
// 		dc.pool, err = dockertestx.NewPool("")
// 		if err != nil {
...
// 	runOpts := &dockertestx.RunOptions{
// 		Name:         name,
// 		Repository:   "nginx",
// 		Tag:          dc.versionTag,
...
// func (dc *dockerNginx) GetPool() *dockertestx.Pool {
// 	return dc.pool
// }

// // GetResource returns docker resource
// func (dc *dockerNginx) GetResource() *dockertestx.Resource {
