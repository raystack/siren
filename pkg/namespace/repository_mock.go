...
func (_m *NamespaceRepositoryMock) Create(_a0 *domain.EncryptedNamespace) (*domain.EncryptedNamespace, error) {
	ret := _m.Called(_a0)

	var r0 *domain.EncryptedNamespace
	if rf, ok := ret.Get(0).(func(*domain.EncryptedNamespace) *domain.EncryptedNamespace); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*domain.EncryptedNamespace) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *NamespaceRepositoryMock) Update(_a0 *domain.EncryptedNamespace) (*domain.EncryptedNamespace, error) {
	ret := _m.Called(_a0)
