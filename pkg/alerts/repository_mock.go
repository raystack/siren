...
func (_m *MockAlertRepository) Create(_a0 *domain.Alert) (*domain.Alert, error) {
	ret := _m.Called(_a0)

	var r0 *domain.Alert
	if rf, ok := ret.Get(0).(func(*domain.Alert) *domain.Alert); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*domain.Alert) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
