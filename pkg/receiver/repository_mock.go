...
func (_m *MockReceiverRepository) Create(_a0 *model.Receiver) (*model.Receiver, error) {
	ret := _m.Called(_a0)
...
func (_m *MockReceiverRepository) Get(_a0 uint64) (*model.Receiver, error) {
	ret := _m.Called(_a0)

	var r0 *model.Receiver
	if rf, ok := ret.Get(0).(func(uint64) *model.Receiver); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.Receiver)
...
func (_m *MockReceiverRepository) List() ([]*model.Receiver, error) {
	ret := _m.Called()

	var r0 []*model.Receiver
	if rf, ok := ret.Get(0).(func() []*model.Receiver); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.Receiver)
...
func (_m *MockReceiverRepository) Update(_a0 *model.Receiver) (*model.Receiver, error) {
	ret := _m.Called(_a0)
