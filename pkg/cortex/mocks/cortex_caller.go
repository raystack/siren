...
// NewCortexCaller creates a new instance of CortexCaller. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCortexCaller(t testing.TB) *CortexCaller {
	mock := &CortexCaller{}
	mock.Mock.Test(t)
