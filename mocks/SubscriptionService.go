...
func (_m *SubscriptionService) CreateSubscription(_a0 context.Context, _a1 *domain.Subscription) (*domain.Subscription, error) {
...
func (_m *SubscriptionService) UpdateSubscription(_a0 context.Context, _a1 *domain.Subscription) (*domain.Subscription, error) {
	ret := _m.Called(_a0, _a1)
