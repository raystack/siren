...
func (_m *SubscriptionService) Create(_a0 context.Context, _a1 *subscription.Subscription) (uint64, error) {
	ret := _m.Called(_a0, _a1)

	var r0 uint64
	if rf, ok := ret.Get(0).(func(context.Context, *subscription.Subscription) uint64); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(uint64)
	}
...
func (_c *SubscriptionService_Create_Call) Return(_a0 uint64, _a1 error) *SubscriptionService_Create_Call {
...
func (_m *SubscriptionService) Update(_a0 context.Context, _a1 *subscription.Subscription) (uint64, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *SubscriptionService_Update_Call) Return(_a0 uint64, _a1 error) *SubscriptionService_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
