...
// 	if c.Cortex.PrometheusAlertManagerConfigYaml == "" || c.Cortex.PrometheusAlertManagerHelperTemplate == "" {
// 		return nil, errors.New("empty prometheus alert manager config template")
// 	}

// 	cortexClient, err := cortex.NewClient(cortex.Config{Address: c.Cortex.Address},
// 		cortex.WithHelperTemplate(c.Cortex.PrometheusAlertManagerConfigYaml, c.Cortex.PrometheusAlertManagerHelperTemplate),
// 	)
// 	if err != nil {
